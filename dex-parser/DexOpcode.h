#ifndef _DEX_OPCODE_H
#define _DEX_OPCODE_H
enum DexOpcode
{
	OP_NOP = 0x00,
      	OP_MOVE = 0x01,
      	...
      	OP_RETURN_VOID = 0x0e, //return void
      	OP_RETURN = 0x0f, // return with return value in v?
      	OP_CONST = 0x14,
	...
	OP_IF_GEZ = 0x3b,
 	...
 	OP_SHR = 0x99,
 	OP_USHR = 0x9a,
 	OP_ADD_INT_LIT_X = 0xd8,
 	OP_RSUB_INT_LIT_X = 0xd9,
 	OP_MUL_INT_LIT_X = 0xda,
 	OP_DIV_INT_LIT_X = 0xdb,
 	OP_REM_INT_LIT_X = 0xdc,
 	OP_AND_INT_LIT_X = 0xdd,
 	OP_OR_INT_LIT_X = 0xde,
 	OP_XOR_INT_LIT_X = 0xdf,
 	OP_SHL_INT_LIT_X = 0xe0,
 	OP_SHR_INT_LIT_X = 0xe1,
 	OP_USHR_INT_LIT_X = 0xe2,
//dex  ernal opcode
	OP_MOVE_FROM16 = 0x02,
      	OP_MOVE_16 = 0x03,
      	OP_MOVE_WIDE = 0x04,
	...
	OP_INVOKE_VIRTUAL_QUICK_RANGE = 0xf9,
    	...
    	OP_IPUT_OBJECT_VOLATILE = 0xfc,
      	...
      	OP_CONST_CLASS_JUMBO = 0x00ff00,
      	OP_CHECK_CAST_JUMBO = 0x00ff01,
      	OP_INSTANCE_OF_JUMBO = 0x00ff02,
      	OP_NEW_INSTANCE_JUMBO = 0x00ff03,
      	OP_NEW_ARRAY_JUMBO = 0x00ff04,
      	OP_FILLED_NEW_ARRAY_JUMBO = 0x00ff05,
      	OP_IGET_JUMBO = 0x00ff06,
      	OP_IGET_WIDE_JUMBO = 0x00ff07,
      	OP_IGET_OBJECT_JUMBO = 0x00ff08,
      	OP_IGET_BOOLEAN_JUMBO = 0x00ff09,
      	OP_IGET_BYTE_JUMBO = 0x00ff0a,
      	OP_IGET_CHAR_JUMBO = 0x00ff0b,
      	OP_IGET_SHORT_JUMBO = 0x00ff0c,
    	OP_IPUT_JUMBO = 0x00ff0d,
      	OP_IPUT_WIDE_JUMBO = 0x00ff0e,
      	OP_IPUT_OBJECT_JUMBO = 0x00ff0f,
      	OP_IPUT_BOOLEAN_JUMBO = 0x00ff10,
      	OP_IPUT_BYTE_JUMBO = 0x00ff11,
      	OP_IPUT_CHAR_JUMBO = 0x00ff12,
      	OP_IPUT_SHORT_JUMBO = 0x00ff13,
      	OP_SGET_JUMBO = 0x00ff14,
      	OP_SGET_WIDE_JUMBO = 0x00ff15,
      	OP_SGET_OBJECT_JUMBO = 0x00ff16,
      	OP_SGET_BOOLEAN_JUMBO = 0x00ff17,
      	OP_SGET_BYTE_JUMBO = 0x00ff18,
      	OP_SGET_CHAR_JUMBO = 0x00ff19,
      	OP_SGET_SHORT_JUMBO = 0x00ff1a,
      	OP_SPUT_JUMBO = 0x00ff1b,
      	OP_SPUT_WIDE_JUMBO = 0x00ff1c,
      	OP_SPUT_OBJECT_JUMBO = 0x00ff1d,
      	OP_SPUT_BOOLEAN_JUMBO = 0x00ff1e,
      	OP_SPUT_BYTE_JUMBO = 0x00ff1f,
      	OP_SPUT_CHAR_JUMBO = 0x00ff20,
      	OP_SPUT_SHORT_JUMBO = 0x00ff21,
      	OP_INVOKE_VIRTUAL_JUMBO = 0x00ff22,
      	OP_INVOKE_SUPER_JUMBO = 0x00ff23,
      	OP_INVOKE_DIRECT_JUMBO = 0x00ff24,
      	OP_INVOKE_STATIC_JUMBO = 0x00ff25,
      	OP_INVOKE_INTERFACE_JUMBO = 0x00ff26,
      	OP_INVOKE_OBJECT_INIT_JUMBO = 0x00fff2,
      	OP_IGET_VOLATILE_JUMBO = 0x00fff3,
      	OP_IGET_WIDE_VOLATILE_JUMBO = 0x00fff4,
      	OP_IGET_OBJECT_VOLATILE_JUMBO = 0x00fff5,
      	OP_IPUT_VOLATILE_JUMBO = 0x00fff6,
      	OP_IPUT_WIDE_VOLATILE_JUMBO = 0x00fff7,
      	OP_IPUT_OBJECT_VOLATILE_JUMBO = 0x00fff8,
      	OP_SGET_VOLATILE_JUMBO = 0x00fff9,
      	OP_SGET_WIDE_VOLATILE_JUMBO = 0x00fffa,
      	OP_SGET_OBJECT_VOLATILE_JUMBO = 0x00fffb,
      	OP_SPUT_VOLATILE_JUMBO = 0x00fffc,
      	OP_SPUT_WIDE_VOLATILE_JUMBO = 0x00fffd,
      	OP_SPUT_OBJECT_VOLATILE_JUMBO = 0x00fffe,
*/
};
