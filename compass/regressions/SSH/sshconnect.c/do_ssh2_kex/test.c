...
do_ssh2_kex(void)
{
	...
	kex->k[KEX_DH_GRP1_SHA1] = kexdh_server;
	kex->k[KEX_DH_GRP14_SHA1] = kexdh_server;
	kex->k[KEX_DH_GEX_SHA1] = kexgex_server;
	kex->k[KEX_DH_GEX_SHA256] = kexgex_server;
	kex->server = 1;
