// SSH/auth1.c auth_password buggy
...
void test_authpassword(Authctxt *authctxt, const char *password)
{
	int res = auth_password(authctxt, password);
	static_assert(res == 1); // should fail
}
