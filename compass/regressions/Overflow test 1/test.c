...
/*
 * This tests for integer overflow in xcalloc causing the condition
 * (SIZE_T_MAX / nmemb < size) to be incorrectly valid.
 */
void duck_testing()
{
  //should fail
  static_assert(0);
  Key *k = xcalloc(1, sizeof(*k));
